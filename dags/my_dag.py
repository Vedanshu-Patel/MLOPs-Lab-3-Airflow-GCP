...
from src.model_development import evaluate, predict, load_data, load_model, build_model, data_preprocessing
...
# conf.set('core', 'enable_xcom_pickling', 'True') not needed in Airflow 3

# Default arguments for DAG
default_args = {
    'owner': 'Vedanshu Patel',
...
task_send_email = PythonOperator(
    ...
    # provide_context = True, not needed in Airflow 3
    dag=dag,
)
...
load_data_task >> data_preprocessing_task >> separate_data_outputs_task >> build_save_model_task >> task_eval_model >> task_predict >> task_send_email
